...
/// A public commitment to the current state of a [`Chain`] -- safe to
...
/// carries none of [`ConsentEventRecord`]'s contents (session/request IDs,
...
pub struct LedgerCheckpoint {
    ...
    pub entry_count: u64,
    /// [`Chain::last_hash`] at the time this checkpoint was produced --
