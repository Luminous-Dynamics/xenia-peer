...
checks={
 ...
 'bounded_verifier_registry': 'MAX_AUTHENTICATION_VERIFIERS_V1' in src and 'TooManyVerifiers' in src,
 'duplicate_verifier_rejection': 'DuplicateVerifierIdentity' in src,
 'exact_verifier_lookup': 'pub fn find_exact(' in src,
}
